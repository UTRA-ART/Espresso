...
Should be run everytime the camera is adjusted on Espresso. zed_wrapper zed.launch must be running. 
'''
...
class ZedWrapperServer:
    ...
    def get_depths(self, data=None):
        ...
        # cv2.imwrite('/home/spencer/Documents/ART/espresso-ws/' + 'DELETE.PNG', copy * scale)
